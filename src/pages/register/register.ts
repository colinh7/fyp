...
createEntry() : void
{
   let options 	: any		= { "uuid" : this.user.uuid , "firstName" : this.user.firstName, "lastName": this.user.lastName, "phoneNumber": this.user.phoneNumber, "emailAddress" : this.user.email },
